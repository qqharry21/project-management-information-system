              ...
              <div
                ...
                <div className='flex-1 flex flex-col gap-1'>
                  ...
                  <div className='text-xs flex items-center gap-2'>
                    ...
                    {sub.dueStatus === 'overdue' && <Badge variant='destructive'>已逾期</Badge>}
                    {sub.dueStatus === 'today' && <Badge variant='default'>今日到期</Badge>}
                    {sub.dueStatus === '3days' && <Badge variant='outline'>3天內到期</Badge>}
                    {sub.dueStatus === '7days' && <Badge variant='secondary'>7天內到期</Badge>}
                  </div>
